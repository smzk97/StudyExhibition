...
function get_main_param(oid,pagination_str){
    let ts = Math.round(Date.now() / 1e3).toString();
    let v = `mode=3&oid=${oid}&pagination_str=%7B%22offset%22%3A%22${pagination_str}%22%7D&plat=1&type=1&web_location=1315875&wts=${ts}`;
